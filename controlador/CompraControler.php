<?php
    ...
    include_once '../modelo/Conexion.php'; //Para utilizar un nuevo modelo
                                            //es necesario utilizar include_once
    $venta = new Venta();
    session_start();
    $vendedor = $_SESSION['usuario']; //Obtenemos el id del vendedor
        ...
        try{
            ...
            foreach($productos as $prod){
                ...
                while ($cantidad != 0) {
                    ...
                    $lote=$query->fetchall();
                        //Algoritmo para reducir los lotes
