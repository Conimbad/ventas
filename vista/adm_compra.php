                            ...
                            <header>
                                ...
                                <div class="datos_cp">
                                    ...
                                    <div class="form-group row">
                                        <span>NIT: </span>
                                        <div class="input-group-append col-md-6">
                                            <input type="number" class="form-control" id="nit" placeholder="Ingresa NIT">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <span>Vendedor: </span>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="info-box mb-3 bg-warning">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <span class="info-box-number"id="con-iva">2</span>
                                                    </div>
                                                </div>
                                                <div class="info-box mb-3 bg-info">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <span class="info-box-number" id="total-sin-descuento">12</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
